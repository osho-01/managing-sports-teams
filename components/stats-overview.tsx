            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="hidden sm:table-cell min-w-[100px]">Rebounds</TableHead>
                  <TableHead className="hidden sm:table-cell min-w-[100px]">Assists</TableHead>
                  <TableHead className="hidden md:table-cell min-w-[80px]">Steals</TableHead>
                  <TableHead className="hidden md:table-cell min-w-[80px]">Blocks</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                    ...
                    <TableRow key={player.id}>
                      ...
                      <TableCell className="font-medium">
                        ...
                        <div className="sm:hidden text-xs text-muted-foreground">
                          Reb: {player.rebounds.toFixed(1)} | Ast: {player.assists.toFixed(1)}
                        </div>
                      </TableCell>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="min-w-[80px]">Opponent</TableHead>
